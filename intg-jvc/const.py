...
class SimpleCommands(StrEnum):
    ...
    CONTENT_TYPE_AUTO = "Content Type Auto"
    CONTENT_TYPE_SDR = "Content Type SDR"
    CONTENT_TYPE_HDR10 = "Content Type HDR10"
    CONTENT_TYPE_HDR10P = "Content Type HDR10+"
    CONTENT_TYPE_HLG = "Content Type HLG"
